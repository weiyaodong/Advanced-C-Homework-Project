...
#define RED				RGB(240, 73, 37)
#define GREEN			RGB(76, 218, 100)
#define BLUE			RGB(18, 154, 232)
#define CYAN			RGB(35, 195, 171)
#define MAGENTA			RGB(237, 112, 180)
#define YELLOW			RGB(245, 217, 91)
#define WHITE			RGB(255, 255, 255)
#define LIGHT_GREY		RGB(248, 248, 248)
#define GREY			RGB(236, 236, 236)
#define DARK_GREY		RGB(124, 124, 124)
#define	LIGHT_RED		RGB(239, 98, 89)
#define LIGHT_PURPLE	RGB(112, 95, 232)
#define LIGHT_GREEN		RGB(162, 239 ,83)
